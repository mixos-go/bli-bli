...
api_name: success_history
url: "https://seller-api.blibli.com/docs/services/66/operations/success_history"
...
This API will return the history of subscribed webhook events that have been successfully sent from Blibli`s to Client`s system.
...
API raw string
GET\n\n\nTue May 12 16:28:52 WIB 2020\n/seller/v1/webhook/success-histories
