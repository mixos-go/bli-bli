...
api_name: reported_order
url: "https://seller-api.blibli.com/docs/services/79/operations/reported_order"
...
Once there is a Shipping by Seller (Big Product) or BOPIS order that has been reported by the customer.
