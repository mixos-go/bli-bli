...
api_name: in_delivery_order
url: "https://seller-api.blibli.com/docs/services/79/operations/in_delivery_order"
...
- Once the order is on delivery progress. Means that the order has been received by 3PL (3rd Party Logistic) or is on the way to the Customer.
