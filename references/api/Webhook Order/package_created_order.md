...
api_name: package_created_order
url: "https://seller-api.blibli.com/docs/services/79/operations/package_created_order"
...
- Once the order package has been created, a notification will always be sent with the 'packageCreated' field is true
