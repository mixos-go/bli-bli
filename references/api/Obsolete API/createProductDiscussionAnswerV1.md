...
api_name: createProductDiscussionAnswerV1
url: "https://seller-api.blibli.com/docs/services/66/operations/createProductDiscussionAnswerV1"
...
# Create Product Discussion Answer V1
...
2. This API let you to send answer to a specific question based on the question code specified on the path variable.
