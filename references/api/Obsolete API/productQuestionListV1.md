...
api_name: productQuestionListV1
url: "https://seller-api.blibli.com/docs/services/66/operations/productQuestionListV1"
...
1. List of questions sent by the customers, along with the amount of answers posted (from all channels).
2. Also give you information whether the User (from Username sent in param) had already read the question or not.
...
API raw string
GET\n\n\nTue May 12 16:28:52 WIB 2020\n/mtaapi/api/businesspartner/v1/product/discussion/questions
