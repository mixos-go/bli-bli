...
api_name: pickupPointDetailV1
url: "https://seller-api.blibli.com/docs/services/66/operations/pickupPointDetailV1"
...
This API is deprecated, so it will no longer supported.

Expectation

Gives you detail information about the existing pickup point from one Seller.
...
API raw string
GET\n\n\nTue May 12 16:28:52 WIB 2020\n/mtaapi/api/businesspartner/v1/product/getPickupPointDetail
