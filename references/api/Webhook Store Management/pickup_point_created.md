...
api_name: pickup_point_created
url: "https://seller-api.blibli.com/docs/services/79/operations/pickup_point_created"
...
This webhook will notify the user with the result of creating a new Pickup Point using Create Pickup Point V1 API or via Blibli Seller Center
