...
api_name: store_binding_request_status_changes
url: "https://seller-api.blibli.com/docs/services/79/operations/store_binding_request_status_changes"
...
# Store Bind Request Status Changes
...
The seller respond to the request that was triggered from API Bind Request by either approving, rejecting, or ignoring it.
