...
api_name: store_bind_status_changes
url: "https://seller-api.blibli.com/docs/services/79/operations/store_bind_status_changes"
...
- Seller bind or unbind their store
- The Store is terminated, resigned, or rejected.
