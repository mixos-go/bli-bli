...
api_name: blibliPromoStatisticsV1
url: "https://seller-api.blibli.com/docs/services/66/operations/blibliPromoStatisticsV1"
...
Give you a revenue statistic for the specified Blibli Promo that Seller has been participated.

Validation

1. The requested Promo Code on the path parameter should be from a Promo that has status ENDED or LIVE.
2. This API can only be accessed by active Seller.

Limitation

5 requests per promo ID per hour.

API raw string
GET\n\n\nTue May 12 16:28:52 WIB 2020\n/seller/v1/promos/blibli/CAMP-07486/statistics
