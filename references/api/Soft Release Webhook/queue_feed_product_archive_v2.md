...
api_name: queue_feed_product_archive_v2
url: "https://seller-api.blibli.com/docs/services/79/operations/queue_feed_product_archive_v2"
...
# Archive Unarchive Product SKU Queue Status Update
...
Once the product has finished the queue process after the product has been successfully archived by using Archive Product and Unarchive Product API.
