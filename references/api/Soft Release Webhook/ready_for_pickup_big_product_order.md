...
api_name: ready_for_pickup_big_product_order
url: "https://seller-api.blibli.com/docs/services/79/operations/ready_for_pickup_big_product_order"
...
# Order Status - Ready to Pickup for Shipping by Seller Order
...
- Once the order status turned to be PU (Pick Up) for Shipping by Seller type.
