...
api_name: ready_for_pickup_bopis_order
url: "https://seller-api.blibli.com/docs/services/79/operations/ready_for_pickup_bopis_order"
...
# Order Status - Ready to Pickup for BOPIS
...
- Once the order status turned to be BP (ready to deliver) for BOPIS type.
