...
api_name: ready_for_pickup_order
url: "https://seller-api.blibli.com/docs/services/79/operations/ready_for_pickup_order"
...
# Order Status - Ready to Pickup for Regular Order
...
- Once the order status turned to be PU (Pick Up) for Regular type.
