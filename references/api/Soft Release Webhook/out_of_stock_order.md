...
api_name: out_of_stock_order
url: "https://seller-api.blibli.com/docs/services/79/operations/out_of_stock_order"
...
# Order Status - Out of Stock Order
...
- Once there is an order for an out of stock product (OS).
