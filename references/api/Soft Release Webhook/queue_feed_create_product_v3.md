...
api_name: queue_feed_create_product_v3
url: "https://seller-api.blibli.com/docs/services/79/operations/queue_feed_create_product_v3"
...
# Create Product V3 Queue Status Update
...
Once there is an update with queue result after creating product using Create Product V3 API .
