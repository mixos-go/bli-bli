...
api_name: partial_fulfillment_order
url: "https://seller-api.blibli.com/docs/services/79/operations/partial_fulfillment_order"
...
# Order Status - Partial Fulfillment Order
...
- Once the order is fulfilled partially (PF).
