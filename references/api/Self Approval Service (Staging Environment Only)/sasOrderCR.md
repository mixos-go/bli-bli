...
api_name: sasOrderCR
url: "https://seller-api.blibli.com/docs/services/65/operations/sasOrderCR"
...
- Order item ID which will be configured to CR (Customer Request) status.

Expectation

The order status will updated to CR (Customer Request) for testing purposes.
