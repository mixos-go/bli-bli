...
api_name: product_changes_l5
url: "https://seller-api.blibli.com/docs/services/79/operations/product_changes_l5"
...
# Product Variant Pickup Point Changes
...
- Product creation
- CNC flag updates
- Buyable flag updates
- Pickup Point info updates
- Prices updates (except promo). Any price changes of products in promo  will not trigger this webhook.
